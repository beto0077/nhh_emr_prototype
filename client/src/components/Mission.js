  ...
  return (
    <div style={{marginTop: '2rem'}}>
      ...
      <p className="text-white container">
        The Mission of New Hope Hospital is to provide compassionate, accessible, high quality,
      ...
      <br/>
      <p className="text-white container">
        New Hope Hospital will be an innovative, leading regional health system dedicated to advancing the
