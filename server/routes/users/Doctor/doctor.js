...
const SECRET_KEY = 'Arijit'; //Fix keys...
...
import { getDoctors, getDoctor, createDoctor, updateDoctor, deleteDoctor, loginDoctor, getDoctorPatients } from "../../../controllers/doctor.controller.js";

const router = Router();

router.post('/login', loginDoctor)
router.get('/doctorPatients/:id', getDoctorPatients)
